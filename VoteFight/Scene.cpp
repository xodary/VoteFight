...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, _T("Terrain/VoteFightHeightMap.raw"), 257, 257, xmf3Scale, xmf4Color);
	...
	// m_ppShaders[0] = new CStandardObjectsShader("ObjectData/TreeData.txt", 0);
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[10].BaseShaderRegister = 14; //t14: Texture
	...
	pd3dRootParameters[0].Descriptor.ShaderRegister = 0; //Texture
	...
	pd3dRootParameters[12].Descriptor.ShaderRegister = 7; //Skinned Bone Offsets
	pd3dRootParameters[12].Descriptor.RegisterSpace = 0;
	pd3dRootParameters[12].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX;

	pd3dRootParameters[13].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;
	pd3dRootParameters[13].Descriptor.ShaderRegister = 8; //Skinned Bone Transforms
...
void CScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	pd3dCommandList->SetGraphicsRootConstantBufferView(ROOTSIG_LIGHT, d3dcbLightsGpuVirtualAddress); //Lights
