...
void CCollider::SetBoundingBox(const XMFLOAT3& center, const XMFLOAT3& extents)
{
	...
	const UINT vertexCount = 14;
	XMFLOAT3 positions[vertexCount] =
	{
		{ m_origin.Center.x + m_origin.Extents.x, m_origin.Center.y + m_origin.Extents.y, m_origin.Center.z + m_origin.Extents.z },
		{ m_origin.Center.x - m_origin.Extents.x, m_origin.Center.y + m_origin.Extents.y, m_origin.Center.z + m_origin.Extents.z },
		{ m_origin.Center.x + m_origin.Extents.x, m_origin.Center.y - m_origin.Extents.y, m_origin.Center.z + m_origin.Extents.z },
		{ m_origin.Center.x - m_origin.Extents.x, m_origin.Center.y - m_origin.Extents.y, m_origin.Center.z + m_origin.Extents.z },
		{ m_origin.Center.x - m_origin.Extents.x, m_origin.Center.y - m_origin.Extents.y, m_origin.Center.z - m_origin.Extents.z },
...
void CCollider::Render(CCamera* camera)
{
    ...
    d3d12GraphicsCommandList->DrawInstanced(14, 1, 0, 0);
}
