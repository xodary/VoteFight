...
namespace DESC
{
	...
	public:
		...
		void AddToHandle(ID3D12Device* device, DESC::DescriptorHandle& destCPUHandle, DESC::DescriptorHandle& sourceCPUHandle)
		{
		...
		void AddToHandle(ID3D12Device* device, DESC::DescriptorHandle& destCPUHandle, D3D12_CPU_DESCRIPTOR_HANDLE& sourceCPUHandle)
		{
