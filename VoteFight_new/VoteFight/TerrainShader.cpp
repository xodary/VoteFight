...
D3D12_INPUT_LAYOUT_DESC CTerrainShader::CreateInputLayout(int stateNum)
{
	...
	d3d12InputElementDescs[1] = { "TEXCOORD0", 0, DXGI_FORMAT_R32G32_FLOAT, 0, 0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
...
{
	return CShader::Compile("main.hlsl", "VS_TERRAIN_INPUT", "vs_5_1", d3d12ShaderBlob);
}

D3D12_SHADER_BYTECODE CTerrainShader::CreatePixelShader(ID3DBlob* d3d12ShaderBlob, int stateNum)
{
	return CShader::Compile("main.hlsl", "VS_TERRAIN_OUTPUT", "ps_5_1", d3d12ShaderBlob);
}
